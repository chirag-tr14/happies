 ...
 * 
 **/
public class WebElementActionsHandler implements WebElementActions{


	private WebDriver driver;
	private LocatorHandler loc = new LocatorHandler();
	public static final Logger logger = LogManager.getLogger(WebElementActionsHandler.class);
	
	public WebElementActionsHandler(WebDriver driver){
		this.driver=driver;
	}
