...
public class CouponRewardsPage extends RDHomePage
{ 
	KeyPerformanceVO  KeyPerformanceVO;
	CampaignPerformanceVO campaignPerformanceVO; 
	public CouponRewardsPage(WebDriver webDriver,PageFactory pgFactory) 
	{
	...
	public List<CampaignPerformanceVO> getCampaignPerformancetablevalues()
	{
        ...
        List<WebElement> rowsCount =returnWebElements(CAMPAINGN_PERFORMANCE_TABLE_COUNT);
